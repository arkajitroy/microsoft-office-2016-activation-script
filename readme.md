...
Follow the instruction and activate the Microsoft Office.

#### Instructions of Activation

1. First open any text editor (example Notepad)
2. Then copy the script which is given just below this.
3. Now save the file with the extension **.cmd** (example: activate.cmd)
4. After that save the file and run it **as administrative**.
5. Wait till it show the product has been activated in the cmd.

#### Point to be Noted

- Make sure the internet is turned on.
- If the windows defender is detecting the file as virus, then off the Real time protection.
...
### Microsoft Office 2019 Activation Script
Copy the code from the snippet and save the whole script in a bat file `activate.bat`
```bash
@echo off
